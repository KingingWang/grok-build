...
fn reinstall_hint(installer: &str, channel: &str) -> String {
    match installer {
        "npm" => "Please reinstall via npm:\n  npm i -g @kingingwang/grok".to_string(),
        "gh-release" => "Please reinstall via GitHub Releases:\n  gh release download --repo KingingWang/grok-build --pattern 'grok-*' --output grok && chmod +x grok".to_string(),
...
/// Download and install grok from GitHub Releases (KingingWang/grok-build).
///
...
fn install_npm(target: Option<&str>, channel: &str, npm_registry: Option<&str>) -> Result<()> {
    ...
    let version_arg = match target {
        Some(ver) => format!("@kingingwang/grok@{ver}"),
        None => {
